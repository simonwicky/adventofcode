...
def instructions_from_lines(lines):
	directions = {'0' : 'R', '1': 'D', '2' : 'L','3' : 'U'}
	instructions = []
	for line in lines:
		index = line.index('#')
		size = int(line[index + 1: index + 6],16)
		direction = directions[line[index + 6]]
		instructions += [direction + ' ' + str(size)]
	return instructions
...
instructions = instructions_from_lines(lines)
