...
row = int(data[data.index("row") + 1][:-1])
col = int(data[data.index("column") + 1][:-1])

start_number = 20151125
for i in range(diagonal_nb(col, row) - 1):
    start_number = step(start_number)
print(start_number)